...
var FolderId = (function (_super) {
    ...
    FolderId.prototype.Validate = function (version) {
        if (version) {
            ...
            if (this.FolderName) {
                EwsUtilities_1.EwsUtilities.ValidateEnumVersionValue(EnumToExchangeVersionMappingHelper_1.EnumToExchangeVersionMappingHelper.WellKnownFolderName, this.FolderName, version);
            }
        }
        else {
