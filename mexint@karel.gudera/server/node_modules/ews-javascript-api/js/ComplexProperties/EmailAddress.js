...
var EmailAddress = (function (_super) {
        ...
        for (var key in jsObject) {
            switch (key) {
                ...
                case XmlElementNames_1.XmlElementNames.MailboxType:
                    this.mailboxType = MailboxType_1.MailboxTypeParser.FromString(jsObject[key]);
                    break;
    ...
    EmailAddress.prototype.WriteElementsToXml = function (writer) {
        ...
        writer.WriteElementValue(XmlNamespace_1.XmlNamespace.Types, XmlElementNames_1.XmlElementNames.MailboxType, MailboxType_1.MailboxTypeParser.ToString(this.MailboxType));
        if (this.Id != null) {
