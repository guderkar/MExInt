...
var AttachmentCollection = (function (_super) {
    ...
    function AttachmentCollection() {
        _super.call(this);
        this.___implementsInterface = ["IOwnedProperty", "ISelfValidate", "IJsonSerializable", "IEnumerable<TComplexProperty>", "ICustomUpdateSerializer", "IJsonCollectionDeserialize"];
        this.___typeName = "Attachment";
    ...
    AttachmentCollection.prototype.AddItemAttachment = function (TItem, TItemElementName) {
        var attachable = Reflect.getMetadata(AttachableAttribute_1.AttachableAttributeMetadata, TItem.prototype) === true; //(typeof(TItem).GetCustomAttributes(typeof(AttachableAttribute), false).Length == 0)        
        if (!attachable) {
            throw new Error(ExtensionMethods_1.StringHelper.Format("Items of type {0} are not supported as attachments.", typeof (TItem).Name)); //InvalidOperationException
        }
    ...
    AttachmentCollection.prototype.Save = function () {
        ...
        return PromiseFactory_1.PromiseFactory.resolve(attachments.length > 0 ? this.InternalDeleteAttachments(attachments) : void 0)
            .then(function () {
            ...
            }, PromiseFactory_1.PromiseFactory.resolve());
        }).then(function () {
