...
var AttachmentsPropertyDefinition = (function (_super) {
    ...
    function AttachmentsPropertyDefinition(propertyName) {
        _super.call(this, propertyName, XmlElementNames_1.XmlElementNames.Attachments, "item:Attachments", PropertyDefinitionFlags_1.PropertyDefinitionFlags.AutoInstantiateOnRead, ExchangeVersion_1.ExchangeVersion.Exchange2007_SP1, function () { return new AttachmentCollection_1.AttachmentCollection(); });
    }
    /**
